...
# --- Data matching your table ---
attack_methods = ["OSA", "Trajectory-Free", "Full Trajectory"]
K_values = [4, 3]

asr_data = {
    "OSA": {4: (100, 11.45), 3: (100, 11.34)},
    "Trajectory-Free": {4: (100, 19.79), 3: (100, 11.34)},
    "Full Trajectory": {4: (100, 32.29), 3: (100, 19.58)}
}
...
ax.set_ylabel("ASR (%)")
ax.set_title("Attack Success Rates (ASR) Before and After Defense")

# --- Legend (remove duplicates and add transparent box) ---
...
# --- Layout & Save ---
plt.tight_layout()
plt.savefig("visualization/dfense_t2.png", dpi=300)
plt.show()
