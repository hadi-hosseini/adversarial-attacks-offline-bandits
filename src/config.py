...
class COFNIG:
    ...
    d: int = 100  # The dimension of attack and mus  # D=1000
    ...
    T: int = 100  # The number of rounds # T=100000
    ...
    hidden_sizes: Tuple = (6000,) # Hidden sizes of the Reward Model 
    is_mse: bool = True # Train reward model as BCE or MSE
    bandit_instance_path = f"./data/bandit_data_k{k}_d{d}_T{T}.npz" # Path to save the bandit instance
    attack_algorithm: str = "epsilon_greedy" # ["ucb", "etc", "epsilon_greedy", "thompson sampling"]
    reward_model_save_path: str = f"./data/reward_model_k{k}_d{d}_T{T}.pt"