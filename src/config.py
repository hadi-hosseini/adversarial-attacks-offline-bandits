...
@dataclass
class COFNIG:
    k: int = 5 # The number of arms # K=3
    d: int = 1000  # The dimension of attack and mus  # D=1000
    n_samples: int = 100000  # The number of samples for each arm in the logged data 
    sigma: float = 1.0  # The variance of Gaussian distribution of each arm
    T: int = 100000  # The number of rounds # T=100000
    ...
    bandit_instance_path = f"./data/bandit_data_d{d}.npz" # Path to save the bandit instance
