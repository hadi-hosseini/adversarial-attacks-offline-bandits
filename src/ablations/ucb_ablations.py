...
def ablation1_ucb(k, d, T, mu, logged_data, epsilon_attack, W=None, reward_model=None):
    find_perturbation = FindPerturbationUCB(k, d, mu, logged_data, epsilon_attack, qp=False, W=W)
    ...
    run_ucb_with_created_perturbation(k, d, T, mu, logged_data, perturbation, reward_model)
...
def heuristic1_ucb(k, d, T, mu, logged_data, epsilon_attack, qp=False, reward_model=None):
    find_perturbation = AdaptivePerturbationUCB(k, d, T, mu, logged_data, epsilon_attack, qp=qp, reward_model=reward_model)
